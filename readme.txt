...
Free pre-order plugin for WooCommerce. Allow people to place pre-orders before the products are available to the public
...
Please note that you need to have the WooCommerce plugin installed to activate this plugin.
